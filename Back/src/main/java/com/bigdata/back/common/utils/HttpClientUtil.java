...
public class HttpClientUtil {
     ...
     * 根据一个url发起get请求
     */
    public static Result<String> gather(HttpClient httpClient, String url, String refererUrl, List<Map<String, String>> headers) throws IOException {
        String result = null;
        //创建get方式请求对象
        ...
        return ResultUtil.data(statusCode,result,response.getStatusLine().getReasonPhrase());
    }
