...
import com.bigdata.flink.util.MySQLUtil;
 ...
 */
public class SourceFromMySQL extends RichSourceFunction<Object> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        connection = MySQLUtil.getConnection("com.mysql.jdbc.Driver",
                "jdbc:mysql://172.18.1.6:3306/rtdw?useUnicode=true&characterEncoding=UTF-8",
                "root",
                "root123456");
